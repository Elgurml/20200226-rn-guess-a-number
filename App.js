...
// function to tell expo which fonts to load
const fetchFonts = () => {
...
export default function App() {
  ...
  // AppLoadinf takes a parameter startAsync and its value has to be a function and that function has to return a promise (loadAsync returns a promise)
